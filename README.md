...
3. Parsing through the command line to fetch flags and execute functionnalities
4. Creating an AST to create an architecture
5. Execute commands (ls, mkdir) via the executable ArchiMaker
6. Compile the project with NO memory leak
